 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.5/source/reswords.h $
 * $Revision: #2 $
 * $Change: 4808 $
...
enum TOKEN_IDS
{
  ...
  // ***Yu Ji*** //
  LIGHTFIELD_SLABS_TOKEN,
  LIGHT_FIELD_SUBIMG_HEIGHT_TOKEN,
  LIGHT_FIELD_SUBIMG_WIDTH_TOKEN,
  LIGHT_FIELD_SLAB_LENGTH_TOKEN,
  LIGHT_FIELD_SLAB_LENGTH_EX_TOKEN,
  LIGHT_FIELD_SLAB_HEIGHT_TOKEN,
  LIGHT_FIELD_SLAB_HEIGHT_EX_TOKEN,
  // ***Yu Ji*** //
