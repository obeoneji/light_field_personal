 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.5/source/reswords.cpp $
 * $Revision: #2 $
 * $Change: 4808 $
...
const RESERVED_WORD Reserved_Words[LAST_TOKEN] = {
  ...
  // *** Yu Ji *** //
  {LIGHTFIELD_SLABS_TOKEN, "light_field_slabs"},
  {LIGHT_FIELD_SUBIMG_HEIGHT_TOKEN, "camera_num_in_height"},
  {LIGHT_FIELD_SUBIMG_WIDTH_TOKEN, "camera_num_in_width"},
  {LIGHT_FIELD_SLAB_LENGTH_TOKEN, "slabs_length"},
  {LIGHT_FIELD_SLAB_LENGTH_EX_TOKEN, "slabs_length_ex"},
  {LIGHT_FIELD_SLAB_HEIGHT_TOKEN, "slabs_height"},
  {LIGHT_FIELD_SLAB_HEIGHT_EX_TOKEN, "slabs_height_ex"},
  // *** Yu Ji *** //
